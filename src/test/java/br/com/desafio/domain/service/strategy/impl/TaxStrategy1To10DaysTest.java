...
class TaxStrategy1To10DaysTest {
    ...
    void shouldApplyTaxStrategyFor1To10Days() {
        ...
        // when
        boolean isApplicable = taxStrategy1To10Days.isApplicable(transferDate, AMOUNT_100, today);
    ...
    void shouldCalculateCorrectTaxFor1To10Days() {
        ...
        // then
        assertThat(tax).isEqualByComparingTo(FIXED_TAX);  // O valor da taxa é fixo (12.00)
    }
